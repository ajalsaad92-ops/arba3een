...
export default function WalkieTalkie() {
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-950/40 to-[#0d0d0d] border-2 border-indigo-500/30 rounded-2xl p-5 md:p-6 mt-5">
      ...
      <div className="relative mb-4">
        <button
          ...
          className="w-full flex items-center justify-between gap-2 bg-[#232323] border border-[#2c2c2c] rounded-lg px-3 py-3 text-sm text-white hover:border-indigo-500/40 transition-colors"
        >
        ...
        {pickerOpen && (
          <div className="absolute z-20 mt-1 w-full bg-[#1a1a1a] border border-[#232323] rounded-lg shadow-2xl max-h-72 overflow-y-auto p-1 animate-fade-in-up">
            <button
      ...
      <div className="mb-4 rounded-lg bg-[#0d0d0d] border border-[#232323] p-3">
          ...
          <>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              {[
                ...
                <div key={c.label} className="rounded-md bg-[#1a1a1a] border border-[#232323] px-2 py-1.5 text-center">
      ...
      {isDirector && (
        <div className="mb-4 rounded-lg bg-[#0d0d0d] border border-indigo-500/20 p-3 space-y-3">
          <div>
            ...
            {onlineUsers.length === 0 ? (
              ...
              <div className="flex flex-wrap gap-1.5">
                {onlineUsers.map((u) => (
                  <span key={u.id} className="text-[10px] px-2 py-0.5 rounded-full bg-[#1a1a1a] border border-[#232323] text-slate-300">
        ...
        <button
          ...
          className={`w-full mb-3 py-2.5 rounded-lg text-xs font-bold transition-colors flex items-center justify-center gap-2 border ${
            directorListening
              ...
              : 'bg-[#232323] border-[#2c2c2c] text-slate-400 hover:text-slate-200'
          }`}
        >
