    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 mt-2 w-72 bg-[#1a1a1a] border border-[#232323] rounded-xl shadow-2xl z-[801] p-3 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-1.5">
              {presets.map(p => (
                <button
                  ...
                  className="px-2 py-1.5 rounded-md bg-[#0d0d0d] border border-[#232323] text-[11px] text-slate-300 hover:border-amber-500/40 hover:text-amber-300"
                >
                  {p.label}
                </button>
              ))}
            </div>
            <div className="border-t border-[#232323] pt-3 space-y-2">
              ...
              <div className="flex items-center gap-2">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0d0d0d] border border-[#232323] rounded px-2 py-1 text-[11px] text-white"
                  />
                </div>
                <div className="flex-1">
